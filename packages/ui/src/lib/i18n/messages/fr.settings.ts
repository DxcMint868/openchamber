...
export const settingsDict = {
  ...
  'settings.openchamber.sessionNavigation.title': 'Navigation entre les sessions',
  'settings.openchamber.sessionNavigation.field.cycleRecentSessions': 'Parcourir les sessions récentes avec Ctrl + Tab',
  'settings.openchamber.sessionNavigation.field.cycleRecentSessionsInfo': 'Maintenez Ctrl et appuyez sur Tab pour parcourir les sessions récentes. Relâchez Ctrl pour changer de session.',
  'settings.openchamber.sessionNavigation.field.browserWarning': 'Peut ne pas fonctionner dans le navigateur. Utilisez l’application de bureau.',
