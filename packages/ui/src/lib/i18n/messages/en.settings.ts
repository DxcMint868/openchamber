...
export const settingsDict = {
  ...
  'settings.openchamber.sessionNavigation.title': 'Session Navigation',
  'settings.openchamber.sessionNavigation.field.cycleRecentSessions': 'Cycle through recent sessions with Ctrl + Tab',
  'settings.openchamber.sessionNavigation.field.cycleRecentSessionsInfo': 'Hold Ctrl and press Tab to cycle through recent sessions. Release Ctrl to switch.',
  'settings.openchamber.sessionNavigation.field.browserWarning': 'May not work in browsers. Use the desktop app.',
