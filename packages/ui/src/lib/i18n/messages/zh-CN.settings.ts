...
'settings.remoteInstances.clientAuth.actions.addDevice': '添加设备',
  ...
  'settings.openchamber.sessionNavigation.title': '会话导航',
  'settings.openchamber.sessionNavigation.field.cycleRecentSessions': '使用 Ctrl + Tab 循环切换最近会话',
  'settings.openchamber.sessionNavigation.field.cycleRecentSessionsInfo': '按住 Ctrl 并按 Tab，在最近的会话间循环选择。松开 Ctrl 即可切换。',
  'settings.openchamber.sessionNavigation.field.browserWarning': '可能无法在浏览器中使用。请改用桌面应用。',
