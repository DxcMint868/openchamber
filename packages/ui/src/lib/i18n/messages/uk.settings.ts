...
"settings.remoteInstances.clientAuth.actions.addDevice": "Додати пристрій",
  ...
  "settings.openchamber.sessionNavigation.title": "Навігація сеансами",
  "settings.openchamber.sessionNavigation.field.cycleRecentSessions": "Перемикатися між нещодавніми сеансами за допомогою Ctrl + Tab",
  "settings.openchamber.sessionNavigation.field.cycleRecentSessionsInfo": "Утримуйте Ctrl і натискайте Tab, щоб перебирати нещодавні сеанси. Відпустіть Ctrl, щоб перемкнутися.",
  "settings.openchamber.sessionNavigation.field.browserWarning": "У браузері може не працювати. Скористайтеся настільним застосунком.",
