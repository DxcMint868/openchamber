...
'settings.remoteInstances.clientAuth.actions.addDevice': '新增裝置',
  ...
  'settings.openchamber.sessionNavigation.title': '工作階段導覽',
  'settings.openchamber.sessionNavigation.field.cycleRecentSessions': '使用 Ctrl + Tab 循環切換最近的工作階段',
  'settings.openchamber.sessionNavigation.field.cycleRecentSessionsInfo': '按住 Ctrl 並按 Tab，在最近的工作階段間循環選取。放開 Ctrl 即可切換。',
  'settings.openchamber.sessionNavigation.field.browserWarning': '可能無法在瀏覽器中使用。請改用桌面應用程式。',
