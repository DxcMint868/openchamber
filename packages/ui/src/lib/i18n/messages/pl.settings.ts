...
export const settingsDict = {
  ...
  'settings.openchamber.sessionNavigation.title': 'Nawigacja po sesjach',
  'settings.openchamber.sessionNavigation.field.cycleRecentSessions': 'Przełączaj ostatnie sesje za pomocą Ctrl + Tab',
  'settings.openchamber.sessionNavigation.field.cycleRecentSessionsInfo': 'Przytrzymaj Ctrl i naciskaj Tab, aby przechodzić między ostatnimi sesjami. Zwolnij Ctrl, aby przełączyć.',
  'settings.openchamber.sessionNavigation.field.browserWarning': 'Może nie działać w przeglądarce. Użyj aplikacji komputerowej.',
