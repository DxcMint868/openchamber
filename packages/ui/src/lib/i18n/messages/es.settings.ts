...
"settings.remoteInstances.clientAuth.actions.addDevice": "Añadir un dispositivo",
  ...
  "settings.openchamber.sessionNavigation.title": "Navegación entre sesiones",
  "settings.openchamber.sessionNavigation.field.cycleRecentSessions": "Recorrer las sesiones recientes con Ctrl + Tab",
  "settings.openchamber.sessionNavigation.field.cycleRecentSessionsInfo": "Mantén pulsado Ctrl y pulsa Tab para recorrer las sesiones recientes. Suelta Ctrl para cambiar.",
  "settings.openchamber.sessionNavigation.field.browserWarning": "Puede que no funcione en el navegador. Usa la aplicación de escritorio.",
