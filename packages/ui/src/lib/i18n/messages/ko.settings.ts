...
'settings.remoteInstances.clientAuth.actions.addDevice': '기기 추가',
  ...
  'settings.openchamber.sessionNavigation.title': '세션 탐색',
  'settings.openchamber.sessionNavigation.field.cycleRecentSessions': 'Ctrl + Tab으로 최근 세션 순환',
  'settings.openchamber.sessionNavigation.field.cycleRecentSessionsInfo': 'Ctrl을 누른 채 Tab을 눌러 최근 세션을 차례로 선택합니다. Ctrl을 놓으면 전환됩니다.',
  'settings.openchamber.sessionNavigation.field.browserWarning': '브라우저에서는 작동하지 않을 수 있습니다. 데스크톱 앱을 사용하세요.',
