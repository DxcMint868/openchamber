...
"settings.remoteInstances.clientAuth.actions.addDevice": "Adicionar um dispositivo",
  ...
  "settings.openchamber.sessionNavigation.title": "Navegação de sessões",
  "settings.openchamber.sessionNavigation.field.cycleRecentSessions": "Alternar entre sessões recentes com Ctrl + Tab",
  "settings.openchamber.sessionNavigation.field.cycleRecentSessionsInfo": "Mantenha Ctrl pressionado e pressione Tab para percorrer as sessões recentes. Solte Ctrl para alternar.",
  "settings.openchamber.sessionNavigation.field.browserWarning": "Pode não funcionar no navegador. Use o aplicativo para desktop.",
